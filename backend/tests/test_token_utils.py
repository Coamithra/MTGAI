...
class TestCheckPostCall:
    ...
    def test_input_truncation_detected(self):
        """Should raise when Ollama processed far fewer tokens than sent."""
        data = {
            "prompt_eval_count": 1000,
            "eval_count": 200,
            "done_reason": "stop",
        }
        # We estimated 5000 tokens but Ollama only processed 1000
    ...
    def test_output_truncation_done_reason_length(self):
        """Should raise when done_reason is 'length'."""
        data = {
            "prompt_eval_count": 500,
            "eval_count": 8192,
            "done_reason": "length",
    ...
    def test_output_truncation_hit_num_predict(self):
        """Should raise when eval_count hits num_predict exactly."""
        data = {
            "prompt_eval_count": 500,
            "eval_count": 4096,
            "done_reason": "stop",
    ...
    def test_zero_prompt_eval_skips_check(self):
        """If prompt_eval_count is 0, skip input truncation check."""
        data = {
            "prompt_eval_count": 0,
            "eval_count": 200,
            "done_reason": "stop",
